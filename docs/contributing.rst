...
by people who works in our institution `IBBA-CNR <https://ibba.cnr.it>`_. Despite
...
1. Open a `new issue <https://github.com/cnr-ibba/BIOINFO-guidelines/issues>`_
...
2. Clone `this repository <https://github.com/cnr-ibba/BIOINFO-guidelines>`_
   in your GitHub account and clone it locally or where you
...
4. Install ``conda`` (or ``miniconda``) if you don't have it yet. You could find
   it at `Anaconda website <https://www.anaconda.com/distribution/>`_
